...
ORGANIZATION = "{{ cookiecutter.# `organization` is a variable that stores the name of the
# organization or individual who owns the project. It is used to
# generate the correct license for the project.
organization }}"
